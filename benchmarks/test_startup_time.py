...
def test_benchmark_startup_time_nbody_cranelift_jit(benchmark):
...
def test_benchmark_startup_time_nbody_cranelift_native(benchmark):
...
def test_benchmark_startup_time_nbody_llvm_jit(benchmark):
...
def test_benchmark_startup_time_nbody_llvm_native(benchmark):
...
def test_benchmark_startup_time_nbody_singlepass_jit(benchmark):
...
def test_benchmark_startup_time_nbody_singlepass_native(benchmark):
